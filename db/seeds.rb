...
skill2 = Skill.create!(color: "#f16529", all: true, backend: "false", frontend: "true", name: "HTML", difficulties: ["beginner", "intermediate", "advanced"], description: "HTML is the set of markup symbols or codes inserted into a file intended for display on the Internet. The markup tells web browsers how to display a web page's words and images.", resources: [htmlres1, htmlres2, htmlres3, htmlres4])
...
skill5 = Skill.create!(color: "#858eba", all: true, backend: "true", frontend: "false", name: "PHP", difficulties: ["beginner", "intermediate", "advanced"], description: "PHP is a widely-used open source general-purpose scripting language that is especially suited for web development and can be embedded into HTML.", resources: [phpres1, phpres2])
...
skill8 = Skill.create!(color: "#DDFFF7", all: true, backend: "true", frontend: "false", name: "SQL", difficulties: ["beginner", "intermediate", "advanced"], description: "SQL is a standardized programming language that is used to manage relational databases and perform various operations on the data in them.", resources: [pythonres1, pythonres2])
