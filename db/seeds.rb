...
skill1 = Skill.create!(color: "#9B2015", frontend: false, name: "Ruby", difficulties: ["Beginner", "Intermediate", "Advanced"], description: "Ruby is a dynamic, general-purpose programming language most commonly used for Web Development. Its key designer, Yukihiro Matsumoto, said that Ruby was designed for humans, not machines, making it a favorite of many developers and tech companies. Its most popular implementation is with the powerful Ruby on Rails web framework.", resources: [rubyres1, rubyres2, rubyres3, rubyres4, rubyres5, rubyres6])
skill2 = Skill.create!(color: "#EB8934", frontend: true, name: "HTML", difficulties: ["Beginner", "Intermediate", "Advanced"], description: "HTML is the set of markup symbols or codes inserted into a file intended for display on the Internet. The markup tells web browsers how to display a web page's words and images.", resources: [htmlres1, htmlres2, htmlres3, htmlres4])
skill3 = Skill.create!(color: "#3483EB", frontend: true, name: "CSS", difficulties: ["Beginner", "Intermediate", "Advanced"], description: "CSS is a style sheet language used for describing the presentation of a document written in a markup language such as HTML. CSS is a cornerstone technology of the World Wide Web, alongside HTML and JavaScript.", resources: [cssres1, cssres2, cssres3, cssres4, cssres5, cssres6])
skill4 = Skill.create!(color: "#DDFFF7", frontend: false, name: "Python", difficulties: ["Beginner", "Intermediate", "Advanced"], description: "Python is an easy to learn, powerful programming language. It has efficient high-level data structures and a simple but effective approach to object-oriented programming", resources: [jsres1, jsres2])
skill5 = Skill.create!(color: "#858EBA", frontend: false, name: "PHP", difficulties: ["Beginner", "Intermediate", "Advanced"], description: "PHP is a widely-used open source general-purpose scripting language that is especially suited for web development and can be embedded into HTML.", resources: [phpres1, phpres2])
skill6 = Skill.create!(color: "#EBD934", frontend: true, name: "JavaScript", difficulties: ["Beginner", "Intermediate", "Advanced"], description: "JavaScript is a high-level, often just-in-time compiled language that conforms to the ECMAScript standard. It has dynamic typing, prototype-based object-orientation, and first-class functions.", resources: [pythonres1, pythonres2, pythonres3, pythonres4, pythonres5, pythonres6])
skill7 = Skill.create!(color: "#DDFFF7", frontend: false, name: "C++", difficulties: ["Beginner", "Intermediate", "Advanced"], description: "C++ is a general-purpose programming language created by Danish computer scientist Bjarne Stroustrup as an extension of the C programming language, or C with Classes. The language has expanded significantly over time, and modern C++ now has object-oriented, generic, and functional features in addition to facilities for low-level memory manipulation.", resources: [pythonres1, pythonres2])
skill8 = Skill.create!(color: "lightgrey", frontend: false, name: "SQL", difficulties: ["Beginner", "Intermediate", "Advanced"], description: "SQL is a standardized programming language that is used to manage relational databases and perform various operations on the data in them.", resources: [pythonres1, pythonres2])
