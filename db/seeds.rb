...
skill1 = Skill.create!(name: "Ruby", frontend: false, difficulties: ["Beginner", "Intermediate", "Advanced"], description: "A dynamic, open source programming language with a focus on simplicity and productivity. It has an elegant syntax that is natural to read and easy to write.", resources: [rubyres1, rubyres2, rubyres3, rubyres4, rubyres5, rubyres6])
skill2 = Skill.create!(name: "HTML", backend: false, difficulties: ["Beginner", "Intermediate", "Advanced"], description: "(HTML) is the set of markup symbols or codes inserted into a file intended for display on the Internet. The markup tells web browsers how to display a web page's words and images.", resources: [htmlres1, htmlres2, htmlres3, htmlres4])
skill3 = Skill.create!(name: "CSS", backend: false, difficulties: ["Beginner", "Intermediate", "Advanced"], description: "is a style sheet language used for describing the presentation of a document written in a markup language such as HTML. CSS is a cornerstone technology of the World Wide Web, alongside HTML and JavaScript.", resources: [cssres1, cssres2, cssres3, cssres4, cssres5, cssres6])
skill4 = Skill.create!(name: "Python", frontend: false, difficulties: ["Beginner", "Intermediate", "Advanced"], description: "Python is an easy to learn, powerful programming language. It has efficient high-level data structures and a simple but effective approach to object-oriented programming", resources: [jsres1, jsres2])
skill5 = Skill.create!(name: "PHP", frontend: false, difficulties: ["Beginner", "Intermediate", "Advanced"], description: "PHP is a widely-used open source general-purpose scripting language that is especially suited for web development and can be embedded into HTML.", resources: [phpres1, phpres2])
